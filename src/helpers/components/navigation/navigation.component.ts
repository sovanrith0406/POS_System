...
export class NavigationComponent implements OnChanges, OnInit, AfterViewInit, OnDestroy
{
    ...
    @Output() readonly appearanceChanged: EventEmitter<NavigationAppearance> = new EventEmitter<NavigationAppearance>();
    @Output() readonly modeChanged: EventEmitter<NavigationMode> = new EventEmitter<NavigationMode>();
    @Output() readonly openedChanged: EventEmitter<boolean> = new EventEmitter<boolean>();
    @Output() readonly positionChanged: EventEmitter<NavigationPosition> = new EventEmitter<NavigationPosition>();
    ...
    ngAfterViewInit(): void
    {
        ...
        setTimeout(() => {
            ...
            if ( !this._navigationContentEl.nativeElement.classList.contains('ps') )
            {
                ...
                const activeItem = this._navigationContentEl.nativeElement.querySelector('.navigation-item-active');
            ...
            else
            {
                ...
                this._scrollbarDirectives.forEach((ScrollbarDirective) => {
                    ...
                    ScrollbarDirective.scrollToElement('.navigation-item-active', -120, true);
                });
            }
        });
    }
    ...
    private _showAsideOverlay(): void
    {
        ...
        this._asideOverlay.classList.add('helpers-navigation-aside-overlay');
